...
#   /Users/zhengchaowang/Applications/CPLEX_Studio<edition>12XX - Linux
#   /Users/zhengchaowang/Applications/CPLEX_Studio<edition>12XX - UNIX
#   ~/Applications/IBM/ILOG/CPLEX_Studio<edition>12XX - Mac OS X
#   C:\Program Files\IBM\ILOG\CPLEX_Studio<edition>12XX - Windows
if (UNIX)
    message(STATUS "this is unix system")
    set(CPLEX_ILOG_DIRS /Users/zhengchaowang/Applications/IBM/ILOG /Users/zhengchaowang/Applications)  #/Users/zhengchaowang/Applications        replace opt/IBM/ILOG
    ...
    if (APPLE)
        message(STATUS "OOOOOH, I come to APPLE")
        set(CPLEX_ILOG_DIRS $ENV{HOME}/Applications ${CPLEX_ILOG_DIRS}) #/IBM/ILOG after Applications are deleted
        foreach (suffix "osx" "darwin9_gcc4.0")
            ...
            message(STATUS "${CPLEX_LIB_PATH_SUFFIXES}")
        endforeach ()
    else ()
        set(CPLEX_LIB_PATH_SUFFIXES
...
if (NOT CPLEX_STUDIO_DIR)
    foreach (dir ${CPLEX_ILOG_DIRS})
        message(STATUS "${CPLEX_ILOG_DIRS} ")
        ...
        if (CPLEX_STUDIO_DIRS)
            ...
            message(STATUS "I Want to see if I am here")
            break()
        endif ()
    endforeach ()
    if (NOT CPLEX_STUDIO_DIR_)
        message(STATUS "Just to check if I am here")
        set(CPLEX_STUDIO_DIR_ CPLEX_STUDIO_DIR-NOTFOUND)
    endif ()
    set(CPLEX_STUDIO_DIR ${CPLEX_STUDIO_DIR_}) #CACHE PATH "Path to the CPLEX Studio directory" Why this CACHE PATH cause problems?
    message(STATUS " hum ${CPLEX_STUDIO_DIR}  ${CPLEX_STUDIO_DIR_}")
endif ()
...
if (UNIX)
    ...
    message(STATUS "I am checking here CPLEX library ${CPLEX_LIBRARY} ${CPLEX_DIR} ${CPLEX_LIB_PATH_SUFFIXES}")
